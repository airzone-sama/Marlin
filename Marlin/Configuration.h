...
#define CUSTOM_MACHINE_NAME "Ender-3 SKR13 DualZ"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 404.9 }   // Originally E = 93 calc to 105... 413 initial for geared E from CW.
