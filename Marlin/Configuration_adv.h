...
//#define EXTRUDER_RUNOUT_PREVENTRunout
 ...
 */
#define E0_AUTO_FAN_PIN P2_03  // Was P2_04
...
#define Z_STEPPER_AUTO_ALIGN
  ...
  //#define Z_STEPPER_ALIGN_X {  10, 189 }  // 10, 215  // 56 169
  //#define Z_STEPPER_ALIGN_Y { 125,  125 }  // 215, 10   // 205, 56
  #define Z_STEPPER_ALIGN_XY { {  10, 125 }, { 189,  125 } }
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   125  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define FILAMENT_UNLOAD_PURGE_RETRACT      125  // (mm) Unload initial retract length.  13
...
#define CUSTOM_USER_MENUS
  ...
  #define CUSTOM_USER_MENU_TITLE "Setup Commands"
  ...
  #define USER_DESC_2 "Home & ABL"
  #define USER_GCODE_2 "G28\nG29"

  #define USER_DESC_3 "Home & Z-Align"
